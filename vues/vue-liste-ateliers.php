        ...
        <?php while($atelier = $reponse ->fetch()){?>
                <tr class="alert" role="alert">
                  ...
                  <td>
                      ...
                      <form method='POST' action="vue-liste-stagiaires.php">
                      ...
                      <td>
                        ...
                        <form action="../controleurs/ctrl-suppr-atelier.php" method="POST">

                          <input type="hidden" name="numAtelier" value="<?php echo $atelier['numAtelier']?>">
                          <input type="submit" name="supprimer" value="&times;" class="btn btn-primary">
